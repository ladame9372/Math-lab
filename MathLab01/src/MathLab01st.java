...
// Leave comments in place for any methods that you have not finished.
	...
	{	
		...
		System.out.println("Octagon Perimeter:                " + Geometry.hexagonPerimeter(side));
	...
	{	
		...
		System.out.println("Parallelogram Area:               " + Geometry.parrallelogramArea(base1,height));
...
class Geometry
{
	...
	public static double parrallelogramArea (double base, double height) 
	{
		return height * base;
